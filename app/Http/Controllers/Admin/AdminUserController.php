...
class AdminUserController extends Controller
{
    ...
    //     if (
    //         $request->filled('encrypted_bank_account') &&
    ...
    public function store(Request $request)
    {
        ...
        DB::beginTransaction();
        try {
            // Check if an unregistered user exists with same email or phone
            ...
            if ($existingUser) {
                // Update the existing unregistered entry instead of creating a new one
            ...
            // ----- Create/Update BusinessProfile (without city/address) -----
            $profileData = [
                'user_id'            => $user->id,
                'kyc_status'         => 'verified',
                'application_status' => 'approved',
